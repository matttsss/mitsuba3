...
if __name__ == "__main__":
    ...
    january_image = render(january, res)
    february_image = render(february, res)

    average = render(average, res)
    ...
    average = mi.Bitmap(average).convert(mi.Bitmap.PixelFormat.RGB, mi.Bitmap.Float32)
    ...
    mi.util.write_bitmap("results/real_average.exr", average)
